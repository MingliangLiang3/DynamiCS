...
def parse_args(args):
    ...
    parser.add_argument(
        "--sampling-probabilities-file",
        type=str,
        default=None,
        help="Optional JSON file of per-sample probabilities used in webdataset filtering.",
    )
    parser.add_argument(
        "--csv-separator",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to dataset_catalog for conducting zero shot evaluation.",
    )
    parser.add_argument(
        "--logs",
        type=str,
