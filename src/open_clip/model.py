...
class CLIPVisionCfg:
    ...
    gaussian_masking: bool = False # use normal masking instead of patch masking
    gaussian_masking_std: float = 0.2 # the standard deviation for Gaussian masking
    attentional_pool: bool = False  # whether to use attentional pooler in the last embedding layer (overrides pool_type)
    attn_pooler_queries: int = 256  # n_queries for attentional pooler
    attn_pooler_heads: int = 8  # n heads for attentional_pooling
    no_ln_pre: bool = False  # disable pre transformer LayerNorm
    pos_embed_type: str = 'learnable' # 'learnable', 'sin_cos_1d', 'sin_cos_2d'
...
def resize_text_pos_embed(state_dict, model, interpolation: str = 'linear', antialias: bool = False):
    ...
    old_pos_embed = state_dict.get('text.positional_embedding', None)
    ...
    state_dict['text.positional_embedding'] = new_pos_embed
